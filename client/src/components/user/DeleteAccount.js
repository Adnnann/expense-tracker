    ...
    <div>
      <Card className={classes.card}>
        ...
        <CardActions>
          <div style={{ margin: '0 auto' }}>
            <Button color='primary' variant='contained' onClick={confirm} className={classes.save}>
              Save
            </Button>
      ...
      <div>
        ...
        >
          ...
          >
            <h2 id='unstyled-modal-title' style={{ color: 'white', fontWeight: 'bold' }}>
              DELETE ACCOUNT
            </h2>
            <p id='unstyled-modal-description' style={{ color: 'white' }}>
