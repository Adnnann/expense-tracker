...
import { fetchUserData, 
        ...
        userToken,
        getUserToken } from "../../features/usersSlice"
...
const EditProfile = () =>{
    ...
    useEffect(()=>{
        ...
        if(updatedUserData.hasOwnProperty('message')){
            dispatch(userDataToDisplay({user:values}))
        ...
        {userData.firstName ?
            <Card className={classes.card}>
                <CardContent>
                    ...
                    value={values.firstName ? values.firstName  : ''} onChange={handleChange('firstName')} margin="normal" />
                    <br />

                    <TextField id="lastName" className={classes.textField}
                    value={values.lastName ? values.lastName : ''} onChange={handleChange('lastName')} margin="normal" />
                    <br />

                    <TextField id="nickname" className={classes.textField}
                    value={values.nickname ? values.nickname : '' } onChange={handleChange('nickname')} margin="normal" />
                    <br />
                    <br />
