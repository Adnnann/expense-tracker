...
const EditPassword = () => {
  ...
  return (
    <div>
      ...
      <Dialog
        open={
          // if server return success message for updating password display Dialogue to user
          updatedUserData.hasOwnProperty('message') ? true : false
        }
      >
        <DialogContent>
          <DialogContentText>Password changed successfuly!</DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button color='primary' autoFocus='autoFocus' onClick={redirectToDashboard}>
            Return to dashboard
          </Button>
        </DialogActions>
      </Dialog>
