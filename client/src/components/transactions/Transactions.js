...
import { setFilter, 
          setFilterVarForCharts } from "../../features/usersSlice";
...
const Transactions = () => {
    ...
    return (
     ...
     <Grid container>
        ...
        <Grid container item xs={12} md={12} lg={12} xl={12}>
                ...
                <ButtonGroup style={{marginTop:"4%", marginBottom:'2%', marginLeft:"4%", borderBottomStyle:"solid"}}>
                  <Button className={classes.buttonGroup} onClick={()=>navigate('/dashboard')}>Dashboard</Button>
                ...
                color="primary" 
                style={{marginLeft:'auto', minWidth:'120px', maxHeight:'50px', marginRight:'10%', marginTop:"4%"}}
                onClick={()=>navigate('/transactions/addNewIncome')}>ADD</Button>
           ...
           <Box
            ...
            >
                <ButtonGroup
                    ...
                    variant="text"
                    style={{borderBottom:'solid', borderTop:'solid', borderRadius:'0', borderBottomWidth:'0px', marginLeft:'auto'}}
                >
                    <Button key="one" className={classes.sideButtons} style={{borderBottom:'solid'}} onClick={()=>dispatch(setFilter({income:'income', expense:'expense'}))}>ALL</Button>
                    <Button key="two" className={classes.sideButtons} onClick={()=>dispatch(setFilter({income:'income', expense:''}))}>INCOME</Button>
                    <Button key="three" className={classes.sideButtons} onClick={()=>dispatch(setFilter({income:'', expense:'expense'}))}>EXPENSE</Button>
                </ButtonGroup>
    ...
    <Dialog open={openDeleteModal} fullWidth>
                ...
                <DialogTitle style={{margin:"0 auto", color:"grey"}}>Are you sure you want to delete?</DialogTitle>
           
                <DialogActions>
                <div style={{margin:'0 auto'}}>
                    <Button color='primary' variant="contained" onClick={()=>confirmDeleteOfTransaction()}
                    className={classes.save}>OK</Button>
                    <Button color='primary' variant="contained" onClick={()=>cancelDeleteOfTransaction()}
